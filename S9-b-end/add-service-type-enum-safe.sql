-- Add service_type field to services table with ENUM dropdown (Safe Version)
-- Run this SQL directly in your Supabase SQL Editor
-- This version handles cases where the ENUM might already exist

-- Create ENUM type for service types (this creates the dropdown in Supabase)
-- Use IF NOT EXISTS to avoid errors if it already exists
DO $$ 
BEGIN
...
-- Show the ENUM values available
SELECT 
    enumlabel as service_type_options
FROM pg_enum 
